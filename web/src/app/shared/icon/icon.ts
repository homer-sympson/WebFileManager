 ...
 * Inline SVG icons.
 *
 * Material's icon font would need a network request, so the handful of icons used by the app are
 * inlined instead. Icons are decorative: the surrounding control carries the accessible label.
 */
const ICON_PATHS: Record<IconName, readonly string[]> = {
  archive: [
    'M20 6h-8l-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-2 5h-2v2h2v2h-2v2h-2v-2h2v-2h-2v-2h2v-2h-2V8h2v1h2v2z',
  ],
  ...
  other: [
    'M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 18H6V4h7v5h5v11z',
  ],
  paste: [
